public class ladyBug extends FlyingInsect implements Flyable{
    ...
    public String flyingStyle() {
        return "The " + type + " flies by flapping its back wings beat when it flies. Its front wings, or elytra, are " +
